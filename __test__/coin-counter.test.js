...
describe('coinCounter', () => {
  ...
  //   const change = coinCounter(4.99, 4.99);
  ...
  // test('should leave function if NaN implementing termination case', () => {
  //   const change = coinCounter("%$^");
  //   expect (change).toEqual(undefined);
  // });

  // test('should leave function if remainder equals zero', () => {
  //   const change = coinCounter(0, .25);
  //   expect(change).toEqual(0);
  // });
  test(`it should return 19 quarters, 2 dimes, and 4 pennies`, () => {
